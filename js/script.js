...
function startGame() {
    ...
    if (gameMode === 'gauntlet') {
        saveSessionState();
        document.getElementById('playerModal').style.display = 'none';
        feedback.textContent = 'Starting Gauntlet Mode...';
...
function endGame() {
    if (gameMode === 'casual' || gameMode === 'gauntlet') return;
...
function changeMode() {
    ...
    localStorage.removeItem('gauntletGameState'); // Clear Gauntlet Mode state
    updateWordCount();
}
